...
Prompting workflow:\
Write prompt &rarr; Refine via Meta-prompt &rarr; Finetune prompt &rarr; Evaluate Prompt &rarr;\
<span class="highlighted-text">Repeat if neccessary</span>

- Add all the `context` you can meta prompt task. 
- This workflow saves you a lot of time on complex inference task using reasoning models and deep research workflows
