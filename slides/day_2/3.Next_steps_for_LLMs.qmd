...
![[See what is trending on huggingface.co/](https://huggingface.co/models?pipeline_tag=text-generation&sort=trending)](./figures/llama3.png)
...
![[PREPRINT: Gold-medalist Performance in Solving Olympiad Geometry with AlphaGeometry2](https://arxiv.org/pdf/2502.03544v1)](./figures/AlphaGeometry2)
...
- 🔌 Extensibility with Plugins:::{.column width="40%"}
